...
interface CoinInputTypes extends React.InputHTMLAttributes<HTMLInputElement> {
  ...
  onCoinSelect: (coinCode: string) => void;
}
  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center font-medium bg-gray-100 w-auto rounded-full dark:text-gray-100 py-4 px-4 "
      >
        {selectedCoin?.icon}{' '}
